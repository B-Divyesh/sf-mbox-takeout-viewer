# Streamed, in-browser viewer/search/extractor for multi-GB Gmail Takeout .mbox files (`mbox-takeout-viewer`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://mbox-takeout-viewer.sociobot.in`. Artifact class: `pwa-offline`.
